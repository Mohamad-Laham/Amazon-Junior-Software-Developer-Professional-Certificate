...
public class DrivingSimulationLab {
    ...
    public static void changeGear() {
        ...
        System.out.print("Enter the desired gear P or D or R: ");
        // Set the gear based on user input
        gear =keyBoard.next();
        while (!gear.equals("P") && !gear.equals("D") && !gear.equals("R")){
            System.out.print("Error its not correct enter again: ");
            gear = keyBoard.next();
        }
    }
    ...
    public static void accelerate() {
        ...
        if (isEngineOn == true && !gear.equals("P")) {
            ...
            System.out.println("Error the engin must be on and the gear must be D or R");
        }
    }
    ...
    public static void brake() {
        ...
        if (isEngineOn == true && speed >5) {
            ...
            System.out.println("Error the engin must be on and the speed must be less than 5");
        }
    }
